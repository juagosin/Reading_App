...
enum class BookStatus(
    ...
    PENDING(
        code = 1,
        descriptionRes = R.string.txt_book_status_following,
        backgroundColor = Color.Red.copy(0.1f),
        icon = Icons.Default.Notifications
    ),
    READ(
        code = 2,
        descriptionRes = R.string.txt_book_status_finished,
        backgroundColor = Color.Green.copy(0.1f),
        icon = Icons.Default.Bookmark
    ),
    READING(
        code = 3,
        descriptionRes = R.string.txt_book_status_reading,
        backgroundColor = Color.Yellow.copy(0.1f),
